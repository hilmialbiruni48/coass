"""
Django settings for co_ass project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-%ieso*5=#0*1blh6!5+l3=sy@ohh)u$*2(-%o-!-$ca@*ou+mh')
...
WSGI_APPLICATION = 'co_ass.wsgi.application'
